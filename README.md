...
docker run -v flipstarter:/app/db -p 3000:3000 flipstarter
```
...
docker run -d --restart always --name flipstarter -v flipstarter:/app/db -p 443:3000 -p 80:3000 flipstarter/flipstarter
```
